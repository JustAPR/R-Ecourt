...
const About = () => {
    return (
        <Cont>
            <Info>
                <h3>CaseFlow Hub: E-Portal for Case Management</h3>
                <p>Welcome to <strong>CaseFlow Hub</strong> – a comprehensive e-portal designed for efficient and effective case management. This platform is tailored for legal professionals, people seeking a streamlined approach to manage, track, and report on various cases.
